...
| --- | --- | --- | --- | --- |
| Ngày 1 (01/06) | - Tự động hóa Hạ tầng mạng & ALB (IaC) <br>&emsp; + Viết và thực thi kịch bản CloudFormation để dựng VPC, Public/Private Subnets, IGW, NAT Gateway, và ALB. | 06/01/2026 | 06/01/2026 | [AWS CloudFormation Docs](https://cloudjourney.awsstudygroup.com/) |
| Ngày 1 (01/06) | - Triển khai Database (IaC) <br>&emsp; + Dựng Amazon RDS (SQL Server) hoàn toàn bên trong mạng Private, thiết lập Security Groups kết nối chặt chẽ. | 06/01/2026 | 06/01/2026 | [AWS RDS CloudFormation](https://cloudjourney.awsstudygroup.com/) |
| Ngày 1 (01/06) | - Vận hành ECS Fargate (IaC) <br>&emsp; + Khởi tạo ECS Cluster và cấu hình Fargate Task Definitions. <br>&emsp; + Ánh xạ (Mapping) dịch vụ backend vào Target Group của ALB. | 06/01/2026 | 06/01/2026 | [AWS ECS Documentation](https://cloudjourney.awsstudygroup.com/) |
