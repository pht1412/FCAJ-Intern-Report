...
| Day 2 (05/20) | - **Team Project:** Application Testing & QA <br>&emsp; + Perform thorough manual testing for new functionalities (Dark Mode, Security History). <br>&emsp; + Write and execute automated unit tests for the backend. <br>&emsp; + Generate and analyze code coverage reports using JaCoCo. | 05/20/2026 | 05/20/2026 | [Project Repository](https://github.com/pht1412/Mini-Social-Network.git) |
