...
| --- | --- | --- | --- | --- |
| Ngày 1 (08/06) | - Thiết kế Kiến trúc & Chia sẻ cộng đồng <br>&emsp; + Hoàn thiện bản vẽ sơ đồ kiến trúc AWS. <br>&emsp; + Đăng bài Blog #1 chia sẻ dự án lên group AWS Study Group VN. | 06/08/2026 | 06/08/2026 | Project Architect |
| Ngày 7 (14/06) | - Kỹ thuật Hiệu năng (Load Testing) <br>&emsp; + Soạn kịch bản K6 giả lập 500 người dùng đồng thời (VUs). <br>&emsp; + Thực thi Load Test và đối chiếu giữa máy Local với AWS Cloud. <br>&emsp; + Lập Báo cáo Ngưỡng chịu tải & Phân tích nút thắt hệ thống. | 06/14/2026 | 06/14/2026 | K6 Documentation |
